...
namespace SBaier.Master.Test
{
	...
	public class SampleEliminationSphereGeneratorTest : MeshGeneratorTest
	{
		...
		private void BindSampleEliminationSphereGenerator(int targetSamples, float baseSamplesFactor)
		{
			...
			SampleEliminationSphereGenerator generator = new SampleEliminationSphereGenerator(targetSamples, baseSamplesFactor, sampleElimination, randomPointsGenerator, treeFactory, seed);
